...
class animal extends object { 
    constructor(pos, selected, html, id, visible, thirst,hunger,dead, name, moved) 
    {
      super(pos, selected, html, id, visible);
      this._name = name;
      this._thirst = thirst;
      this._hunger = hunger;
      this._dead = dead;
    ...
    drink(amount) {
        this._thirst = parseInt(this._thirst) + amount;
        this._thirst = Math.min(this._thirst, 10);
    }
    
    eat(amount) {
        this._hunger = parseInt(this._hunger) + amount;
        this._hunger = Math.min(this._hunger, 10);
    }
